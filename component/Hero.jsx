...
const Hero = () => {
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-6 text-white space-y-20 py-10">
        ...
        <section className="space-y-4">
          ...
          <p className="opacity-80 leading-relaxed">
            We celebrate creativity, culture, and cooking. Share what you love
            and learn from others while enjoying a beautiful, community-driven
            platform.
          </p>
          <p className="opacity-80 leading-relaxed">
